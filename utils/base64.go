...
func EncryptMedia(file *multipart.FileHeader, encryptionNeeds dto.EncryptRequest, storagePath string, user dto.UserResponse, method string, typ string) (string, string, string, error) {
